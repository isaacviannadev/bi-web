...
export default function Header() {
  ...
  return (
    ...
    >
      <div className='w-full flex px-8 justify-between items-center lg:px-16 py-2 md:border md:border-brand-gray-50 shadow-header md:rounded-full bg-brand-white bg-opacity-96'>
